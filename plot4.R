...
#plot topright
with(data=datafile2, plot(Time,Voltage, type="n", xlab="datetime"))
with(data=datafile2, lines(Time,Voltage))
...
#plot bottomright
with(data=datafile2, plot(Time,Global_reactive_power, type="n", xlab="datetime"))
with(data=datafile2, lines(Time,Global_reactive_power))
